...
function App() {
  ...
  <div className="health">
    ...
    <div className="progress-container">
      <div className="hours">
        <h1>6:25</h1>
        <p><i className="fas fa-clock health-icons" />&nbsp; Hours</p>
      ...
      <div className="rpm">
        <h1>120</h1>
        <p><i className="fas fa-heartbeat health-icons" />&nbsp; Rpm</p>
        <div className="progress-bar">
          <div className="progress-done" />
        </div>
      </div>
      ...
      <div className="kcal">
        <h1>1.84</h1>
        <p><i className="fas fa-apple-alt health-icons" />&nbsp; Kcal</p>
        <div className="progress-bar">
          <div className="progress-done" />
        </div>
      </div>
  ...
  <div className="your-trainers">
    ...
    <div className="trainer">
      ...
      <div className="message-icon">
        <h1><i className="far fa-comment-dots" /></h1>
      </div>
    </div>
    <div className="trainer">
      <div className="trainer-profile">
